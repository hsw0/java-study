...
public class EntityIdTypeAutoContributor implements TypeContributor {
    ...
    static final Set<String> ELIGIBLE_ANNOTATION_NAMES =
            Set.of(Entity.class.getName(), MappedSuperclass.class.getName(), Embeddable.class.getName());
    ...
    private Set<Class<? extends EntityId<?>>> scanClasses(BootstrapContext bootstrapContext) {
        ...
        for (var name : classNames) {
            ...
            for (var field : clazz.getDeclaredFields()) {
                ...
                Class<? extends EntityId<?>> fieldType =
                        classLoader.classForName(field.getType().getName());
